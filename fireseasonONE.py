...
fn1 = 'C:/Users/modarn/Documents/CASQA/data/ta_day_CMCC-CMS_historical_r1i1p1_19800101-19891231.nc'
fn2 = 'C:/Users/modarn/Documents/CASQA/data/hur_day_CMCC-CMS_historical_r1i1p1_19800101-19891231.nc'
fn3 = 'C:/Users/modarn/Documents/CASQA/data/pr_day_CMCC-CMS_historical_r1i1p1_19800101-19891231.nc'
...
# Define the date range from May 1, 1983, to August 28, 1983
start_date = datetime(1983, 5, 1)
end_date = datetime(1983, 9, 28)
...
# Define the date range from November 1, 1982 to March 31, 1983
start_date_wet = datetime(1982, 11, 1)
end_date_wet = datetime(1983, 3, 31)
# Find the indices of time data that fall within the specified date range
...
output_file_path = 'C:/Users/modarn/Documents/CASQA/data/season1982_1983.nc'
